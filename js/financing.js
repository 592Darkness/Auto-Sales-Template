...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateLoanPayment() {
        ...
        document.getElementById('monthly-payment').textContent = 'G
...
`);
 + monthlyPayment.toFixed(2);
        document.getElementById('loan-amount').textContent = 'G
...
`);
 + loanAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
        document.getElementById('total-interest').textContent = 'G
...
`);
 + totalInterest.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
        document.getElementById('total-cost').textContent = 'G
